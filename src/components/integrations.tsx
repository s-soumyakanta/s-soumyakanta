...
export function Integrations() {
	...
	if (fbPixelID) {
		fbPixel += `fbq('init', '${encodeURIComponent(fbPixelID)}');`;
	}
	...
	const hotjarForUsers =
		...
		(function(h,o,t,j,a,r){
			...
			h._hjSettings={hjid:${encodeURIComponent(hotjarSiteID)},hjsv:6};
	...
	const matomoAnalytics = `
		...
		(function() {
			var u="https://${encodeURIComponent(matomoURL || '')}/";
			_paq.push(['setTrackerUrl', u+'matomo.php']);
			_paq.push(['setSiteId', '${encodeURIComponent(matomoSiteID || '')}']);
			var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0];
			g.type='text/javascript'; g.async=true; g.defer=true; 
			g.src='//cdn.matomo.cloud/${encodeURIComponent(matomoURL || '')}/matomo.js'; 
	...
	const koalaForUsers =
		...
		.forEach(function(t){ko[t]=function(){var n=[].slice.call(arguments);
		return n.unshift(t),ko.push(n),ko}});
		var n=document.createElement("script");
		n.async=!0,n.setAttribute("src","https://cdn.getkoala.com/v1/${encodeURIComponent(koalaPublicKey)}/sdk.js"),
		...
		<>
			...
			{fathomSiteID && (
				<script
					...
					data-spa="auto" // ✅ Corrected: Use `data-spa` instead of `spa`
					defer
				></script>
			)}
