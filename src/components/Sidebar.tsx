...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed md:hidden top-0 left-0 z-50 h-full w-4/5 max-w-xs transform transition-transform duration-300 ease-in-out ${
              ...
              {links.map((link) => {
                ...
                return (
                  <a
                    ...
                    className={`flex items-center justify-center h-14 px-4 py-3 text-base font-medium text-center transition-colors duration-200 cursor-pointer ${
                      isActive
