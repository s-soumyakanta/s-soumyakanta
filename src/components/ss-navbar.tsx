...
import SSSidebar from "./ss-sidebar";

export default function SSNavbar() {
    const { value: isSidebarOpen, onToggle: toggleSidebar, onFalse: closeSidebar } =
        useBoolean(false);
    ...
    return (
        <>
            ...
            <SSSidebar isOpen={isSidebarOpen} onClose={closeSidebar} />
        </>
    );
}